...
if [ $stage -le 0 ]; then
	...
	python python_scripts/prepare_data.py --partitions_dir $partitions_dir --data_dir $data_dir

	# generate spk2utt, accent2utt on train set
	utils/utt2spk_to_spk2utt.pl $data_dir/train/utt2spk > $data_dir/train/spk2utt
	utils/utt2spk_to_spk2utt.pl $data_dir/train/utt2accent > $data_dir/train/accent2utt

	# generate spk2utt, accent2utt on test set
	utils/utt2spk_to_spk2utt.pl $data_dir/test/utt2spk > $data_dir/test/spk2utt
	utils/utt2spk_to_spk2utt.pl $data_dir/test/utt2accent > $data_dir/test/accent2utt

	# generate spk2utt, accent2utt on dev set
...
if [ $stage -le 3 ]; then
    ...
    utils/subset_data_dir.sh data/train_aug 40000 data/train_aug_1m
